...
const Home = props => {
    ...
    return (
        ...
        <div className="card-layout">
            {(showMovies.length < 16) ? <Spinner /> : showMovies.map(movie => {
                return(
                <div className="card">
                <div className="card-overlay"></div>
                    ...
                    <div className="card-body text-white">
                        ...
                        <span className="card-icons">
                           <button className="card-button card-button-like"> <i className="fas fa-heart"></i></button> 
                           <button className="card-button card-button-watch"> <i className="fas fa-tv"></i> </button> 
                        </span>
                    </div>
                </div>
                );
