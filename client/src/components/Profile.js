...
const Profile = ({ getProfile, auth: { user }, profile: { profile, loading }, deleteAcc }) => {
        ...
        <section className="container">
            ...
            {profile !== null ? <Fragment>
                ...
                <table className="table text-white">
                        ...
                        <tbody>
                {favourite && favourite.map(m =>
                        <tr key={m.imdbID}>
                            <td>{m.Title}</td>  
                            <td className="hide-sm">{m.Year}</td>  
                            <td className="hide-sm">{m.imdbID}</td>  
                            <td>
                                <Link to='/edit-profile' className="btn btn-danger">Remove</Link>
                            </td>
                        </tr>)
                }
                        </tbody>
